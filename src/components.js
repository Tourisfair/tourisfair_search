...
import { tfFavorite } from './components/tfFavorite.js';
...
window.customElements.define('tf-favorite', tfFavorite);
window.customElements.define('tf-card-header-image', tfCardHeaderImage);
window.html = html;
window.css = css;
