...
const meta : StyleComponentProps<"tf-main-container"> = {
    ...
    tag: "tf-main-container",
    description: "A  main container with 4 colors: default,primary, secondary and tertiary with corner round up or down",
...
export const styleTfMainContainer = (styleBook: StyleBook) =>
